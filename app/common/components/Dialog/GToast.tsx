...
const renderLeadingIcon = (icon: number) => {
  return (
    <Image
      source={icon}
      style={{ tintColor: AppColors.white, height: 24, marginLeft: 4 }}
      resizeMode={'contain'}
    />
  )
}
...
const styles = StyleSheet.create({
  ...
  defaultToast: {
    borderLeftColor: AppColors.grayOpacity,
    backgroundColor: AppColors.grayOpacity,
    height: 'auto',
    borderRadius: 24,
  ...
  infoToast: {
    borderLeftColor: AppColors.blue400,
    backgroundColor: AppColors.blue400,
  },
  successToast: {
    borderLeftColor: AppColors.green400,
    backgroundColor: AppColors.green400,
  },
  warningToast: {
    borderLeftColor: AppColors.orange400,
    backgroundColor: AppColors.orange400,
  },
  errorToast: {
    borderLeftColor: AppColors.red400,
