    ...
    <View style={[styles.container, style]}>
      {title ? (
        <>
          <HStack style={{ alignItems: 'center', height: 48 }}>
            ...
            {hiddenSwitch ? null : (
              <Switch
                ...
                trackColor={{ false: AppColors.gray300, true: AppColors.blue400 }}
                thumbColor={Platform.OS === 'android' ? AppColors.blue400 : AppColors.white}
          ...
          {isShow ? <Divider style={{ backgroundColor: AppColors.gray200 }} /> : null}
        </>
      ) : null}
      {keepChildren}
